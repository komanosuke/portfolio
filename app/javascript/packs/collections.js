...
const charNameList = [
	['イチバンボシ', 'ウダイジン', 'アメタロー', '五円のゴエモン', 'ケイ王', 'オンプー', 'サガール', 'ひーちゃん', '花のハンナ', 'カイジロー', 'マナブ', 'ヤルキモンキー', 'キュウビノキツネ', 'オヤスミコアラ', '玉やボウヤ', '金のダイブツ', 'ソラ', 'ムーン', 'サムライ犬', 'ミルメ', 'イツツボシ', 'ヒトクチ', '校しゃのすけ', 'サダイジン', 'ミカヅキング', 'マウント', 'コ子', 'シカクガリ', 'イトオカシ', '字じい', 'ミミゾウ', 'レインぼう', 'カーのすけ', 'ハンゾウ', 'ジッテマン', 'デリュウ', 'ゆきおんな', 'スモールスモウマン', 'アガール', 'モーリー', 'タダノヒト', 'ポチャン', 'タダシンジャー', 'セイメイ', 'ブルーバード', '夕日のユーフィー', 'イシマル', '赤いリンゴロウ', 'センボンザクラ', 'カワナガレ', 'サキバシリ', 'ハヤオキハヤオ', 'クサ', 'アシロー', 'ヴィレじい', 'ビッグエレファント', 'ウルフマン', 'たけちゃん', 'ナカンガルー', 'てんとう虫', 'マッチ', '天のつかい エンジェル', 'タンぼう', 'ツッチー', '二人のツインズ', 'オヒサマ', 'ニューゲート', 'いやーおじさん', 'ホワイトタイガー', 'ヤマタノオロチ', '百じゅうの王 ビーストキング', 'サクブン', 'ツリー', 'ホンゾウ', 'ナマエモン', 'メダマの王子', 'タツオ', 'ゴリラのゴウリキ', '林のリンタロー', 'サイコロック']
];
...
function openPopup(num){
	...
	if(80 <= this.num && this.num < 240){
		grade = 1;
		document.getElementById('collection_char_name').textContent = '';
		...
		document.getElementById('collection_char_name').textContent = charNameList[0][this.num];
